package com.breezefieldsalesmmhg.features.logoutsync.presentation
...
import com.breezefieldsalesmmhg.app.utils.Toaster
import com.breezefieldsalesmmhg.base.BaseResponse
import com.breezefieldsalesmmhg.base.presentation.BaseActivity
import com.breezefieldsalesmmhg.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldsalesmmhg.features.billing.api.AddBillingRepoProvider
import com.breezefieldsalesmmhg.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldsalesmmhg.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldsalesmmhg.features.document.model.AddEditDocumentInputParams
import com.breezefieldsalesmmhg.features.document.model.DocumentAttachmentModel
...
import com.breezefieldsalesmmhg.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldsalesmmhg.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldsalesmmhg.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldsalesmmhg.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldsalesmmhg.features.orderhistory.model.*
...
import com.breezefieldsalesmmhg.features.quotation.model.AddQuotInputModel
import com.breezefieldsalesmmhg.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesmmhg.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldsalesmmhg.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldsalesmmhg.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldsalesmmhg.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldsalesmmhg.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldsalesmmhg.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldsalesmmhg.mappackage.SendBrod
import com.breezefieldsalesmmhg.widgets.AppCustomTextView
import com.breezefieldsalesmmhg.MonitorService
import com.breezefieldsalesmmhg.MySingleton
import com.breezefieldsalesmmhg.app.AlarmReceiver
...
import com.breezefieldsalesmmhg.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldsalesmmhg.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldsalesmmhg.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldsalesmmhg.features.orderITC.SyncDeleteOpptL
import com.breezefieldsalesmmhg.features.orderITC.SyncEditOppt
import com.breezefieldsalesmmhg.features.orderITC.SyncOppt
import com.breezefieldsalesmmhg.features.orderITC.SyncOpptProductL
import com.breezefieldsalesmmhg.features.orderITC.SyncOrd
import com.breezefieldsalesmmhg.features.orderITC.SyncOrdProductL
import com.breezefieldsalesmmhg.features.performance.model.Gps_status_list
import com.breezefieldsalesmmhg.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldsalesmmhg.features.returnsOrder.ReturnProductList
import com.breezefieldsalesmmhg.features.returnsOrder.ReturnRequest
import com.breezefieldsalesmmhg.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmmhglogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmmhglogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmmhglogsample/log.zip").path);
